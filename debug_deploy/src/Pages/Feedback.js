...
useEffect(() => { // 서버
  ...
  axios.get(`http://${serverIP}:${port}/mypage`, {
    params: {
        ...
        <MiddleContainer>
          ...
          <EmotionContainer>
                      ...
                      <Happiness>
                        <EmotionDiv>
                        <EmotionName>
                        <img style = {{width:'30px',height:'30px',marginRight:'0.5rem'}} src='./emoticons/Happiness.png'></img>
                        <EmotionName2>
                        <h6 style={{color: "#FFCA75"}}>Happiness</h6>
                        <h7>이 시간대에 시청자들이 가장 행복해요</h7>
                        </EmotionName2>
                        </EmotionName>
